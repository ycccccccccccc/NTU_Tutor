    ...
    return (
        <Row gutter={16} style={{ paddingLeft: 100, paddingRight: 100, paddingTop: 20 }}>
            <Col className="gutter-row" span={6} style={{ paddingTop: 5 }}>
                <Select defaultValue="教學科目" style={{ width: 200 }} onChange={handleChange}>
                    <OptGroup label="教學科目">
                        {
            ...
            <Col className="gutter-row" span={6} style={{ paddingTop: 5 }}>
                <Select defaultValue="預期費用" style={{ width: 200 }} onChange={handleChange}>
                    <OptGroup label="預期費用">
                        {
            ...
            <Col className="gutter-row" span={6} style={{ paddingTop: 5 }}>
                <Select defaultValue="上課地點" style={{ width: 200 }} onChange={handleChange}>
                    <OptGroup label="上課地點">
                        {
                            //這個可以寫fuction 改好看一點
            ...
            <Col className="gutter-row" span={6}>
                ...
                ><FormOutlined /><Link to="/NewTeacherPage"> 我要找老師</Link></Button>
            </Col>
